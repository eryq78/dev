...
class UserCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        // We don't need the password hashing event since it's handled by the model cast
    }
    ...
    protected function setupUpdateOperation()
    {
        ...
        CRUD::field('password')
            ->hint('Type a password to change it.')
            ->validationRules('nullable');
    
        // Add this event to preserve the existing password when none is provided
